...
void PhotoDownloader::init(const QMap<QString,QString>& raw_headers)
{
    QMap<QString, QString>::const_iterator i = raw_headers.constBegin();
    while (i != raw_headers.constEnd())
    {
